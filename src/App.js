...
import { FaLinkedin, FaDownload } from 'react-icons/fa'; // Removed FaGithub

const API_BASE = "https://factorial-backend-top.fly.dev/"; // Updated backend URL
  ...
  return (
    <div className="container">
      ...
      <div className="credits">
        <h3>Created by Daef Al-Shaebi</h3> {/* Updated name */}
